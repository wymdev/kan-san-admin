...
<div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
    ...
    <div class="form-group">
        ...
        <x-ui.input class="form-input" id="signature" name="signature" type="text"
               value="{{ old('signature', $ticket->signature ?? '') }}" />
    </div>
    <div class="form-group">
        <label class="form-label" for="withdraw_date">Withdraw Date*</label>
        <x-ui.input class="form-input" id="withdraw_date" name="withdraw_date" type="date"
    ...
    <div class="form-group">
        ...
        <x-ui.select class="form-input" id="ticket_type" name="ticket_type" required>
    ...
    <div class="form-group">
        ...
        <x-ui.input class="form-input" id="bar_code" name="bar_code"
    ...
    <div class="form-group">
        ...
        <x-ui.input class="form-input" id="period" name="period" type="number"
               value="{{ old('period', $ticket->period ?? '') }}" required />
    </div>
    <div class="form-group">
        <label class="form-label" for="big_num">Big Number</label>
        <x-ui.input class="form-input" id="big_num" name="big_num" type="number"
               value="{{ old('big_num', $ticket->big_num ?? '') }}" />
    </div>
    <div class="form-group">
        <label class="form-label" for="set_no">Set No</label>
        <x-ui.input class="form-input" id="set_no" name="set_no" type="number"
               value="{{ old('set_no', $ticket->set_no ?? '') }}" />
    </div>
    <div class="form-group">
        <label class="form-label" for="price">Price*</label>
        <x-ui.input class="form-input" id="price" name="price" type="number" step="0.01"
    ...
    <div class="form-group col-span-2">
        ...
        <x-ui.input class="form-input" id="left_icon" name="left_icon" type="file" accept="image/*" />
        {{-- Preview on edit --}}
