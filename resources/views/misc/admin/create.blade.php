            ...
            <form method="POST" action="{{ route('users.store') }}">
                ...
                <div class="grid lg:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <x-ui.input type="password" name="password" id="password" placeholder="Enter password"
                    ...
                    <div>
                        ...
                        <x-ui.input type="password" name="confirm-password" id="confirm-password" placeholder="Confirm password"
                               class="form-input" required />
                    </div>
                        ...
                        <div class="grid md:grid-cols-3 gap-3">
                            @foreach($roles as $value => $label)
                                <div class="flex items-center">
                                    <x-ui.input type="checkbox" name="roles[]" value="{{ $value }}"
