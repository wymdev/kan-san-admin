                ...
                <div class="mt-16 lg:max-w-md w-full">
                    <div class="mb-4">
                        <label class="inline-block mb-2 text-sm text-default-800 font-medium" for="employeeID">Employee
                            ID</label>
                        <x-ui.input class="form-input bg-default-100" disabled="" id="employeeID" type="text"
                               value="#TWE1001524" />
                    </div>
                    <div class="mb-4">
                    ...
                    <div class="mb-4">
                        ...
                        <x-ui.input class="form-input" id="ExperienceInput" placeholder="0.4 year" type="text" />
                    </div>
                    <div class="mb-4">
                        <label class="inline-block mb-2 text-sm text-default-800 font-medium" for="createDateInput">Create
                            Date</label>
                        <x-ui.input class="form-input" data-date-format="d M, Y" data-provider="flatpickr"
                ...
                <div class="mt-10 overflow-x-auto">
                    <x-ui.table class="w-full whitespace-nowrap">
                        ...
                        <tr>
                            ...
                            <td class="px-3.5 py-2.5">
                                <x-ui.input class="form-input" placeholder="$00.00" type="number" />
                            </td>
                            <td class="px-3.5 py-2.5">
                                <x-ui.input class="form-input" placeholder="$00.00" type="number" />
                            </td>
